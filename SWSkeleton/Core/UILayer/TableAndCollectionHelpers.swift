...
public extension UITableView {
    ...
    ///
    /// - Parameter _: UITableViewCell.Type that conform RegisterCellProtocol
    func register<T: UITableViewCell>(_ cells : [T.Type]) where T: RegisterCellProtocol {
    ...
    func register<T: UITableViewHeaderFooterView>(_: T.Type) where T: RegisterHeaderFooterViewProtocol {
        self.register(T.self, forHeaderFooterViewReuseIdentifier: T.reuseIdentifier)
    }
    
    func register<T: UITableViewHeaderFooterView>(_ views : [T.Type]) where T: RegisterHeaderFooterViewProtocol {
        views.forEach { (view) in
            self.register(view)
        }
    }

    func registerNib<T: UITableViewHeaderFooterView>(_: T.Type) where T: RegisterHeaderFooterViewProtocol {
        let bundle = Bundle(for: T.self)
        guard (bundle.path(forResource: T.nibName, ofType: "nib") != nil) else {
            fatalError("Could not find xib with name: \(T.nibName)")
        }
    ...
    func dequeueReusableHeaderFooterView<T: UITableViewHeaderFooterView>() -> T where T: RegisterHeaderFooterViewProtocol {
